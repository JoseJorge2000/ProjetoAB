...
def run_docker_for_files(filenames, output, method):
    ...
    for filename in filenames:
        ...
        docker_command = f"docker run -v C:/Users/Utilizador/Desktop/AB/code/Datasets:/data -v C:/Users/Utilizador/Desktop/AB/code/{output}:/output biocontainers/t-coffee:v12.00.7fb08c2-4-deb_cv1 {method} -in /data/{filename} -method clustalw_pair mafft_pair -output fasta_aln -outfile /output/{filename.replace('.fna', '_out.fna')}"
