...
def run_docker_for_files(filenames, output, method):
    ...
    for filename in filenames:
        ...
        docker_command = f"docker run -v {dir}ProjetoAB/code/Datasets:/data -v {dir}AB/code/{output}:/output biocontainers/kalign:v1-2.0320110620-5-deb_cv1 {method} -i /data/{filename} -o /output/{filename.replace('.fna', '_out.fna')}"
